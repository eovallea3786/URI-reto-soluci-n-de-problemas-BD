...
select lifereg.name, round(lifereg.omega * 1.618,3) as 
"The N Factor" from life_registry as lifereg join dimensions 
as d on lifereg.dimensions_id = d.id
and d.name in ('C774','C875') and lifereg.name like 'Richard%' 
